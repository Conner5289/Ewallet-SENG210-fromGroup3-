...
public class User {
    ...
    public ArrayList<Currency> getCurrencyRates() { return currencyRates; }
    public void setCurrencyRates(ArrayList<Currency> currencyRates) { this.currencyRates = currencyRates; }
    public ArrayList<Wage> getIncome() { return income; }
    public void setIncome(ArrayList<Wage> income) { this.income = income; }
    public ArrayList<Expense> getSpending() { return spending; }
    public void setSpending(ArrayList<Expense> spending) { this.spending = spending; }
